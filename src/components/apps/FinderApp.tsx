      ...
      <div className="w-48 bg-gray-100 border-r border-gray-200 py-4">
        <div className="px-4 mb-4">
          ...
          <ul className="mt-2 space-y-1">
            <li className="flex items-center px-2 py-1 text-sm text-gray-700 rounded hover:bg-blue-100 cursor-pointer">
        ...
        <div className="h-10 bg-gray-100 border-b border-gray-200 flex items-center justify-between px-4">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Search"
              className="w-64 pl-8 pr-4 py-1 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm"
            />
            ...
            <div className="grid grid-cols-4 gap-4">
              {projects.map(project => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-center">{project.name}</span>
                </div>
              ))}
            </div>
          ) : (
              ...
              <tbody>
                {projects.map(project => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-sm capitalize">{project.type}</td>
                    <td className="px-4 py-2 text-sm text-gray-500">{project.date}</td>
                  </tr>
                ))}
              </tbody>
            </table>
